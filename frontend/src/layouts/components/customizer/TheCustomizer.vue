...
import { updateTheme } from '../../../store/actionType'
import { TOGGLE_REDUCE_BUTTON, UPDATE_PRIMARY_COLOR } from '../../../store/mutationType'
...
export default {
    ...
    computed: {
        theme: {
            get() {
                return this.$store.layout.state.theme;
            },
            set(val) {
        ...
        reduced_sidebar: {
            get() { return this.$store.state.layout.reduceButton },
        ...
        primaryColor: {
            get() { return this.$store.state.layout.themePrimaryColor },
